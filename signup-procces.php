...
if (!isset($fname)) {
    ...
    if ($checkUser->num_rows == 0) {
        ...
        Database::iud("INSERT INTO `users`(`username`,`first_name`,`last_name`,`email`,`otp`,`password`,`stetus_stetus_id`,`gender_gender_id`,`mobile`,`stetus_dp`) 
        VALUES('" . $username . "','" . $fname . "','" . $lname . "','" . $email . "','" . $otp . "','" . $password . "','1','" . $gender . "','" . $mobile . "','2');");
